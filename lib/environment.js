...
class Environment extends EventEmitter {
  ...
  get(namespaceOrPath) {
    ...
    // Legacy oe-generator `#hookFor()` function is passing the generator path as part
    ...
    if (typeof Generator !== 'function') {
      return this.error(
        new Error(
          ...
          chalk.yellow('npm search oe-generator') + ' or via ' + chalk.yellow('http://yeoman.io/generators/') + '. \n' +
